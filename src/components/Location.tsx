        ...
        <div className="flex flex-col md:flex-row max-w-6xl mx-auto">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-6">
            <div className="bg-stone-100 p-2 rounded-lg shadow-md h-full">
              {/* This is a placeholder for a map. In a real implementation, you would use Leaflet or another map library */}
              <div className="bg-stone-200 h-full min-h-[300px] rounded-md flex items-center justify-center relative">
                <div className="absolute inset-0 bg-stone-300 opacity-50 rounded-md"></div>
                <MapPinIcon size={48} className="text-amber-700 z-10" />
                <div className="absolute bottom-4 left-4 bg-white p-2 rounded-md shadow-sm z-10">
                  <p className="font-medium text-stone-800">
                    Centro Cristiano Gosén
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-stone-50 p-6 rounded-lg shadow-md h-full">
              ...
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-stone-600">CP: 88300</p>
                  <p className="text-stone-600 mt-1">
                    Esquina con Calle Cuarta (4ta)
                  </p>
                </div>
              </div>
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-stone-600">(+52) 123-456-7890</p>
                  <a href="https://wa.me/5212345678901" target="_blank" rel="noopener noreferrer" className="inline-flex items-center mt-2 text-amber-700 hover:text-amber-900">
