            ...
            <div className="bg-stone-50 p-6 rounded-lg shadow-md h-full">
              ...
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <a href="tel:+528679801693" aria-label="Llamar al +52 867 980 1693" className="text-stone-600 hover:underline">+52 867 980 1693</a>
                  <a href="https://wa.me/528679801693" target="_blank" rel="noopener noreferrer" className="flex items-center mt-2 text-amber-700 hover:text-amber-900" aria-label="Enviar WhatsApp al +52 867 980 1693">
